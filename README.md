...
Download Stanford CoreNLP 3.9.0 at <a href="https://stanfordnlp.github.io/CoreNLP/history.html"> download section</a>. To connect your Nodejs application to Stanford CoreNLP:
```sh
